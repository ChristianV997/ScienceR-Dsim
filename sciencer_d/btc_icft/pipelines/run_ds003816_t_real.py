...
def _mock_m_rows() -> list[dict]:
    return [
        {"row_id":"sub-01lt_ses-01_norun_noacq_LKMSelf_win-0_aaaa","subject_id":"sub-01lt","session_id":"ses-01","run_id":"","window_id":"win-0","task_label":"LKMSelf","source_file":"mock/a.vhdr","window_start_s":"0","window_end_s":"10","artifact_score":"0.1"},
        {"row_id":"sub-01lt_ses-01_norun_noacq_PreResting_win-1_bbbb","subject_id":"sub-01lt","session_id":"ses-01","run_id":"","window_id":"win-1","task_label":"PreResting","source_file":"mock/a.vhdr","window_start_s":"10","window_end_s":"20","artifact_score":"0.2"},
        {"row_id":"sub-02st_ses-01_norun_noacq_LKMOther_win-0_cccc","subject_id":"sub-02st","session_id":"ses-01","run_id":"","window_id":"win-0","task_label":"LKMOther","source_file":"mock/b.vhdr","window_start_s":"0","window_end_s":"10","artifact_score":"0.15"},
    ]


def main() -> int:
    p = argparse.ArgumentParser()
    p.add_argument("--m-windows", default="outputs/btc_icft/ds003816/m_real")
    p.add_argument("--out", default="outputs/btc_icft/ds003816/t_real")
    ...
    res = topo.LevelTRealTopologyResult(
        dataset_id="ds003816", n_rows=len(rows), n_subjects=len({r.subject_id for r in rows}), n_windows=len(rows),
        topology_quality_report=q, null_placeholder_report=n, artifact_alignment_report=ar, omega_event=omega,
        safe_claim="Local DS003816-style EEG windows were mapped into operational Level T topology telemetry candidates for future M+T residual testing.",
