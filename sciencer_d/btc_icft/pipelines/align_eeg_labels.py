...
def run(dataset_id:str, signal_features:str, metadata:str|None, out_dir:str, activate_mock_contract:bool=False, mock_fixture:bool=False)->int:
    if mock_fixture:
...
def main()->int:
    ...
    a=p.parse_args()
    return run(a.dataset_id,a.signal_features,a.metadata,a.out,a.activate_mock_contract,a.mock_fixture)
